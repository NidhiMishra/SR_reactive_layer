...
class UserTrackingServiceNewKinectHandler : virtual public UserTrackingServiceNewKinectIf {
 public:
  ...
  void MultiUserSkeletonChanged(const std::string& sensorID, const  ::imi::Microseconds timestamp, const  ::imi::skel& skelposition, const  ::imi::xyskel& xyskelposition) {
    // Your implementation goes here
	...
	if(sensorID=="KinectV2")
	{
		for(int i=0; i<skelposition.size(); i++)
		{
			...
			//std::cout << "Coordinate Received: " << skelposition.at(i).head.x << "\n";
